        ...
        <section className="sejarah" id="sejarah">
          ...
          <div className="content" data-aos="fade-left" data-aos-delay="100">
            ...
            <p data-aos="fade-left" data-aos-delay="200">
              Kalimantan Barat adalah provinsi yang terletak di pulau Borneo,
              Indonesia. Provinsi ini terkenal dengan keindahan alamnya yang
              meliputi hutan hujan tropis, sungai besar, dan keanekaragaman
              hayati yang kaya. Dikelilingi oleh Sungai Kapuas, salah satu
              sungai terpanjang di Indonesia, Kalimantan Barat juga memiliki
              kekayaan budaya yang beragam, dengan masyarakat yang terdiri dari
              berbagai suku dan etnis. Pontianak, ibu kota provinsi, merupakan
              pusat ekonomi dan budaya yang penting, serta menjadi gerbang
              menuju petualangan eksplorasi alam yang menakjubkan di Kalimantan
              Barat.
            </p>
          </div>
        </section>

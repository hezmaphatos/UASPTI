    ...
    <div className="bodyWD">
      ...
      <section className="post-header">
        <a href="/tour" style={{ textDecoration: "none" }}>
          <h1 className="back-from-detail">
            <i className="fas fa-angle-left"></i> BACK
          </h1>
        </a>
        <div className="header-content post-container">
          <h1 className="header-title" data-aos="fade-in" data-aos-delay="100">
            {wisata.nama}
          </h1>
      ...
      <section className="post-content post-container">
        ...
        <p className="post-text" data-aos="fade-right" data-aos-delay="250">
          {wisata.Deskripsi}
        </p>
